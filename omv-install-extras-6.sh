...
echo -e "\033[36m Autoinstaller for Openmediavault 6.x and Extras.org\033[0m"
echo -e "\033[36m Author:     Wolf2000\033[0m"
echo -e "\033[36m Version:         2.1\033[0m"
echo -e "\033[36m https://blog.wolf2000.at/[0m"
echo
echo -e "\033[32m Wolle sie Openmediaut mit Plugins installieren\033[0m"
echo -e "\033[32m Want to install Openmediaut with plugins\033[0m"
...
echo -e "\033[32m That's it Openmediavult and Extras.org is now installed\033[0m"
else echo -e "\033[31m Die Installation wurde abgebrochen\033[0m"
     echo -e "\033[31m The installation was aborted\033[0m"
fi
